import { db } from "./shopConnection.js";
...
if (deleteMode) {
  ...
  db.run(
    ...
    The Apple iPhone 12 comes in different colors like Black, White, Red, Green, and Blue. The dimension of the smartphone is 146.7 x 71.5 x 7.4 mm and it weighs 164 grams. It is IP68 dust/water resistant and supports Single SIM (Nano-SIM and/or eSIM).', 20)`
  );
  db.run(
    `INSERT INTO items (name,price,category,description,inStock) VALUES ('iPad Air (2020)', 10000,'tablets','The tablet features True-tone, Wide color gamut, and 500 nits typ. brightness (advertised) on the display while the size of the screen is 10.9 inches Liquid Retina IPS LCD capacitive touchscreen. It is protected by Scratch-resistant glass and oleophobic coating.
